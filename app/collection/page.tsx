                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="px-1 space-y-1">
                      ...
                      <Link href={`/collection/${blouse._id}`}>
                        <h3 className="font-serif font-bold text-sm text-[#2a2c24] hover:text-[#6b705c] transition cursor-pointer">
                          {blouse.name}
                        </h3>
                      </Link>
                  ...
                  <div className="pt-2">
                    {blouse.inStock ? (
                      <Link
                        ...
                        className="w-full bg-[#2a2c24] text-[#f4f1de] py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-[#3f4236] transition block text-center cursor-pointer"
                      >
                        Add to Bag
                      </Link>
                    ) : (
